  ...
  return (
    <div className="border-b border-zinc-800 px-5 pb-5">
      ...
      <p className="mt-1 text-xs leading-relaxed text-zinc-500">
        Add a password so you can log in on another browser or after clearing site data. Visits stay on the server under your username.
      </p>
      ...
      {accountSecured ? (
        <div className="mt-4 space-y-3">
          <p className="text-sm text-zinc-400">You&apos;re signed in. Use Log in elsewhere with the same username and password.</p>
          <button
            type="button"
            disabled={authBusy}
        ...
        <div className="mt-4 space-y-6">
          {hasLocalId ? (
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500">No server session yet — register to store trips in the database.</p>
              <label className="mt-3 block text-xs text-zinc-400">
                Display name
                <input
                  type="text"
          ...
          <div>
            <p className="text-xs font-medium uppercase tracking-wide text-zinc-500">Log in</p>
            <p className="mt-1 text-xs text-zinc-500">Already have a username? Load your map from the server.</p>
            <label className="mt-3 block text-xs text-zinc-400">
              Username
              <input
                type="text"
